  ...
  const faqs = [
    {
      ...
      answer:
        "Yes. For qualified OEM/ODM partners, Microwear (NJY Tech) provides access to our BLE SDK. This allows your development team to build custom Android/iOS applications that interact directly with our devices (e.g., retrieving heart rate data from the Ultra 5X, or syncing voice data from W Ai 4 glasses). We currently support data integration with the MActivePro and HeyCyan ecosystem. Please contact our engineering team for the API documentation.",
  ...
  return (
    <section className="product-faq-section">
      <div className="product-faq-container">
        <h2 className="product-faq-title">Technical Support & Enterprise FAQ</h2>
