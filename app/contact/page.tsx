      ...
      <div className="contact-container">
        <ScrollReveal>
          <div className="contact-header">
            <h1>Contact Us</h1>
            <p>
              Have a question or want to learn more about our smartwatches?
        ...
        <div className="contact-content">
          ...
          <ScrollReveal delay={0.3} className="contact-info-wrapper">
            <div className="contact-info-section">
              ...
              <div className="contact-info-item">
                ...
                <div>
                  <h3>Email</h3>
                  <p>
                    <a href="mailto:donaldfang@njytech.com.cn">
                      donaldfang@njytech.com.cn
                    </a>
                  </p>
                </div>
              </div>
              ...
              <div className="contact-info-item">
                ...
                <div>
                  <h3>WhatsApp</h3>
                  <p>
                    <a href="tel:+85267337121">+852 6733 7121</a>
                  </p>
                </div>
              </div>
