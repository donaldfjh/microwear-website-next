          ...
          <div style={{
            ...
            <Link href="/products/mw-health-ma25" style={{
              ...
              <div style={{
                ...
                <img 
                  src="/images/products/ma25OverAll.jpg" 
                  alt="Microwear Watch MA25"
              ...
              <div style={{ padding: '16px' }}>
                <h3 style={{ fontSize: '16px', fontWeight: '600', color: '#1e293b', marginBottom: '8px' }}>
                  Microwear Watch MA25
                </h3>
                <p style={{ fontSize: '14px', color: '#64748b' }}>
                  Best OEM Smartwatch for Women&apos;s Health (Period Tracking & ECG).
                </p>
              </div>
            </Link>
            <Link href="/products/mw-health-ma18" style={{
              ...
              <div style={{
                ...
                <img 
                  src="/images/products/ma18Overall.webp" 
                  alt="Microwear Watch MA18"
                  style={{ maxHeight: '180px', maxWidth: '90%', objectFit: 'contain' }}
                />
              </div>
              <div style={{ padding: '16px' }}>
                <h3 style={{ fontSize: '16px', fontWeight: '600', color: '#1e293b', marginBottom: '8px' }}>
                  Microwear Watch MA18
                </h3>
                <p style={{ fontSize: '14px', color: '#64748b' }}>
                  Medical-grade health monitoring smartwatch.
                </p>
              </div>
            </Link>
          </div>
